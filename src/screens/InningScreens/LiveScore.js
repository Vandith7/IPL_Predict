...
import { container, result, teams, teams1, status1, league, league2, match, hr100, hr101, load_text, card, containerb, btn, btn1, teams_yet, containera, head11 } from '../../globals/matchStyle'
    ...
    const getScore = async () => {
        ...
        try {
            const response = await axios.get(
                `https://prod-public-api.livescore.com/v1/api/app/date/cricket/${today}/5.30?MD=1`,
                axiosConfig
            );
            setIsLoading(false);
                ...
                : myData[0] === undefined ? (
                    <><TouchableOpacity onPress={() => navigation.navigate('WelcomePage')} style={back}>
                        ...
                        <View style={containera}>
                            ...
                            <Text style={load_text}>There are no matches today</Text>
                        </View>
                    </>) : (
                    <>
                        <TouchableOpacity onPress={() => navigation.navigate('WelcomePage')} style={back}>
