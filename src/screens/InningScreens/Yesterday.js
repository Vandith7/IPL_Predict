    ...
    const getScore = async () => {
        ...
        try {
            const response = await axios.get(
                `https://prod-public-api.livescore.com/v1/api/app/date/cricket/${yesterday}/5.30?MD=1`,
                axiosConfig
            );
            setIsLoading(false);
                ...
                : myData[0] === undefined ? (
                    <><TouchableOpacity onPress={() => navigation.navigate('WelcomePage')} style={back}>
                        ...
                        <View style={containera}>
                            ...
                            <View style={containerb}>
                                <ScrollView showsHorizontalScrollIndicator={false} horizontal={true} >
                                    ...
                                    <TouchableOpacity
                                        onPress={getScore}
                                        style={card}>
                                        <Text style={btn1}>Yesterday</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity
                            ...
                            <Text style={load_text}>There were no matches yesterday</Text>
                        </View>
                    </>) : (
                    <>
                        <TouchableOpacity onPress={() => navigation.navigate('WelcomePage')} style={back}>
                                            ...
                                            <View>
                                                {item.Events.map((event) => (
                                                    <View style={match}>
                                                        ...
                                                        <Text style={teams}>
                                                            {event.Tr1C2 !== undefined && event.Tr1CW2 !== undefined && event.Tr1CO2 !== undefined ? (<Text style={teams}>{event.Tr1C1}-{event.Tr1CW1} ({event.Tr1CO1} Ovs){"\n"}&{"\n"}{event.Tr1C2}-{event.Tr1CW2} ({event.Tr1CO2} Ovs)</Text>) : event.Tr1C1 !== undefined && event.Tr1CW1 !== undefined && event.Tr1CO1 !== undefined ? (<Text>{event.Tr1C1}-{event.Tr1CW1} ({event.Tr1CO1} Ovs)</Text>) : (<Text style={teams_yet}>Not batted</Text>)}
                                                        </Text>
                                                        <View style={hr100} />
                                                        <Text style={teams1}>{event.T2[0].Nm} </Text>
                                                        <Text style={teams}>
                                                            {event.Tr2C2 !== undefined && event.Tr2CW2 !== undefined && event.Tr2CO2 !== undefined ? (<Text style={teams}>{event.Tr2C1}-{event.Tr2CW1} ({event.Tr2CO1} Ovs){"\n"}&{"\n"}{event.Tr2C2}-{event.Tr2CW2} ({event.Tr2CO2} Ovs)</Text>) : event.Tr2C1 !== undefined && event.Tr2CW1 !== undefined && event.Tr2CO1 !== undefined ? (<Text>{event.Tr2C1}-{event.Tr2CW1} ({event.Tr2CO1} Ovs)</Text>) : (<Text style={teams_yet}>Not batted</Text>)}
                                                        </Text>
                                                        <View style={hr100} />
